  ...
  return (
    ...
    >
      <path
        ...
        fill="#0078D4"
      />
      <path d="M2 19.5H8.2L12.5 12.5L10.3 8.5L2 19.5Z" fill="#50E6FF" />
    </svg>
  );
}
...
export function FlutterIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M14 10.5L8.5 16L14 21.5H17.5L12 16L17.5 10.5H14Z"
        fill="#01579B"
      />
...
export function AwsIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M6 15C9 17 15 17 18 15M16.5 13.5L18.5 15L16.5 16.5"
        stroke="#FF9900"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M6 9L8 13L10 9M11 9V13M14 9C15.5 9 15.5 11 14 11C15.5 11 15.5 13 14 13"
        stroke="white"
        strokeWidth="1.2"
        strokeLinecap="round"
      />
...
export function MongoIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 2C12 2 6 7.5 6 13C6 16.5 8.7 19.5 12 22C15.3 19.5 18 16.5 18 13C18 7.5 12 2 12 2Z"
        fill="#47A248"
        fillOpacity="0.2"
        stroke="#47A248"
        strokeWidth="1.5"
...
export function PostgresIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M8 8C8 6 10 5 12 5C14 5 16 6 16 8C16 11 13 12 13 14H11C11 12 8 11 8 8Z"
        stroke="white"
        strokeWidth="1.5"
      />
      <path
        d="M10 17H14M12 14V19"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function FigmaIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      <path
        d="M8 2H12V7H8C6.6 7 5.5 5.9 5.5 4.5C5.5 3.1 6.6 2 8 2Z"
        fill="#F24E1E"
      />
      <path
        d="M12 2H16C17.4 2 18.5 3.1 18.5 4.5C18.5 5.9 17.4 7 16 7H12V2Z"
        fill="#FF7262"
      />
      <path
        d="M8 7H12V12H8C6.6 12 5.5 10.9 5.5 9.5C5.5 8.1 6.6 7 8 7Z"
        fill="#A259FF"
      />
      <path
        d="M12 7H16C17.4 7 18.5 8.1 18.5 9.5C18.5 10.9 17.4 12 16 12C14.6 12 13.5 10.9 13.5 9.5H12V7Z"
        fill="#1ABCFE"
      />
      <path
        d="M8 12H12V17C12 18.4 10.9 19.5 9.5 19.5C8.1 19.5 7 18.4 7 17C7 15.6 8.1 14.5 9.5 14.5H8V12Z"
        fill="#0ACF83"
      />
    </svg>
  );
...
export function GoogleMapsIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      <path
        d="M12 2C8.1 2 5 5.1 5 9C5 14.2 12 22 12 22C12 22 19 14.2 19 9C19 5.1 15.9 2 12 2Z"
        fill="#EA4335"
      />
...
export function StripeIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      ...
      <path
        d="M10 8.5C10 7.7 10.7 7 11.7 7C13.2 7 14.2 7.7 14.7 8.2L15.5 6.5C14.7 5.8 13.3 5.2 11.7 5.2C9.5 5.2 8 6.5 8 8.7C8 12.2 13 11.5 13 13.5C13 14.5 12 15.2 10.8 15.2C9 15.2 7.8 14.2 7.2 13.5L6.5 15.5C7.2 16.3 8.8 17 10.8 17C13.2 17 15 15.7 15 13.3C15 9.7 10 10.3 10 8.5Z"
        fill="white"
      />
    </svg>
  );
...
export function FirestoreIcon({ className = "h-5 w-5", size }: IconProps) {
  return (
    ...
    >
      ...
      />
      <path
        d="M4 5V12C4 13.7 7.6 15 12 15C16.4 15 20 13.7 20 12V5"
        stroke="#FFA000"
        strokeWidth="1.5"
      />
      <path
        d="M4 12V19C4 20.7 7.6 22 12 22C16.4 22 20 20.7 20 19V12"
        stroke="#F57C00"
        strokeWidth="1.5"
      />
    </svg>
...
export function TechIconByName({
  name,
  className = "h-5 w-5",
}: {
  name: string;
  ...
  if (n.includes("react") || n.includes("ionic react"))
  ...
  if (n.includes("stripe") || n.includes("razorpay"))
