...
export default function IndustriesSection() {
  return (
    <section
      className="relative py-10 md:py-12 overflow-hidden bg-slate-50 border-t border-slate-200"
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 z-10">
        <header className="text-center mb-8">
          ...
          <p className="mt-3 text-base md:text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
            Koraltech Softwares has delivered solutions across healthcare,
            fintech, logistics, e-commerce, learning management, and more.
          </p>
        </header>
